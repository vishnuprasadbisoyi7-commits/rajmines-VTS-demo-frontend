...
function getFallbackVehicles(): Vehicle[] {
  return [
    ...
    },
    {
      ...
      mineral_type: 'White Marble',
      status: 'MOVING',
      last_latitude: 27.051,
      last_longitude: 74.732,
      last_speed: 44.0,
      last_heading: 110.0,
      last_altitude: 448.0,
      last_satellites: 15,
    ...
    },
    {
      id: 'VEH-07',
      reg_no: 'RJ39GA3595',
      imei: '358250331576222',
      vehicle_type: '10-Wheel Dump Truck',
      driver_name: 'Govind Ram',
      driver_phone: '+91 98288 77889',
      capacity_tonnes: 26.0,
      mineral_type: 'Lignite',
      status: 'MOVING',
      last_latitude: 25.751,
      last_longitude: 71.396,
      last_speed: 10.0,
      last_heading: 160.0,
      last_altitude: 123.0,
      last_satellites: 10,
      ...
      last_internal_batt: 4.0,
      last_updated: new Date().toISOString(),
      active_geofence: 'Barmer Lignite Basin',
      active_e_ravanna: 'N/A',
      input_voltage: 27.0,
      gps_fix: 1,
    },
    ...
    },
    {
      id: 'VEH-09',
      reg_no: 'RJ06GD2550',
      imei: '358250331621523',
      vehicle_type: 'Heavy Mineral Dumper',
      driver_name: 'Mahesh Verma',
      driver_phone: '+91 97843 99001',
      capacity_tonnes: 32.0,
      mineral_type: 'Soapstone & Feldspar',
      status: 'MOVING',
      last_latitude: 25.36,
      last_longitude: 74.62,
      last_speed: 38.0,
      last_heading: 320.0,
      last_altitude: 746.0,
      last_satellites: 12,
      ...
      last_internal_batt: 4.0,
      last_updated: new Date().toISOString(),
      active_geofence: 'Bhilwara Mining Zone A',
      active_e_ravanna: 'N/A',
      input_voltage: 27.0,
      gps_fix: 1,
    },
    {
      id: 'VEH-10',
      reg_no: 'RJ04GB5446',
      imei: '358250331623453',
      vehicle_type: 'Multi-Axle Trailer',
      driver_name: 'Mukesh Prajapat',
      driver_phone: '+91 96025 11335',
      capacity_tonnes: 36.0,
      mineral_type: 'Bajri (River Sand)',
      status: 'MOVING',
      last_latitude: 25.76,
      last_longitude: 71.41,
      last_speed: 14.0,
      last_heading: 75.0,
      last_altitude: 239.0,
      last_satellites: 15,
      ...
      last_internal_batt: 4.0,
      last_updated: new Date().toISOString(),
      active_geofence: 'Barmer Riverbed Zone',
      active_e_ravanna: 'N/A',
      input_voltage: 27.0,
      gps_fix: 1,
    },
