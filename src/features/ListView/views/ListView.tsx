...
export const ListView: React.FC = () => {
  ...
  */
  ...
  // NEW API: GET http://localhost:8082/vts/api/vehicle/live
  const [telemetryList, setTelemetryList] = useState<VehicleTelemetryViewDto[]>([]);
    ...
    try {
      ...
      if (json && Array.isArray(json.data)) {
        ...
        const mapped: VehicleTelemetryViewDto[] = data.map((item, idx) => ({
          ...
          packetDate: item.packet_date,
          packetTime: item.packet_time,
          satellites: item.satellites,
          altitude: item.altitude,
          operator: item.operator,
          createdAt: item.updated_at,
        }));
        setTelemetryList(mapped);
  ...
  }, [telemetryList, searchTerm, statusFilter]);
      ...
      <div className="p-4 md:p-5 border-b border-slate-100 dark:border-slate-800 flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-[#0a192f]">
        ...
        <div className="flex flex-wrap items-center gap-3 flex-1 min-w-[280px]">
          ...
          <div className="relative">
            ...
            >
              <option value="ALL">All Vehicles ({telemetryList.length})</option>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-xs text-slate-700 dark:text-slate-300 font-mono">
            {isLoading && filteredTelemetry.length === 0 ? (
              ...
              <tr>
                <td colSpan={13} className="text-center py-12 text-slate-400">
                  No live vehicles matching current filter.
                </td>
              </tr>
            ) : (
